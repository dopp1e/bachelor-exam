...
System wbudowany to komputer (urządzenie z CPU, pamięcią i I/O) który jest częścią większego systemu.
...
#{
  ...
  table(
    ...
    [Zastosowania wojskowe], [Systemy radarowe, systemy nawigacyjne, systemy naprowadzania, drony, systemy komunikacji taktycznej],
