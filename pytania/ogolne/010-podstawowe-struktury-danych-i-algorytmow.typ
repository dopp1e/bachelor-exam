...
Istnieje także coś takiego jak wektor, czyli tablica którą alokuje się dynamicznie i w razie dodawania do niej elementów jest rozszerzana o ileś tam więcej miejsca na więcej elementów. Dzieje się to poprzez stworzenie nowej dynamicznie tablicy o rozmiarze np 2n i przepisuje się wszystkie elementy do tej tablicy.
...
- Drzewa binarne - jeden węzeł może mieć co najwięcej dwoje dzieci. Można w nich wyróżnić regularne drzewo binarne, w którym każdy węzeł ma albo 2 lub 0 dzieci.
- #grid(
    columns: (1fr, auto),
    gutter: 1em,
    [
